      ...
      <Table>
        ...
        <Table.Body>
          ...
          <Table.Row>
            ...
            <Table.Cell>
              <Icon className="universe-text" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-ticket</Table.Cell>
            <Table.Cell>
              <Icon className="universe-ticket" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-time</Table.Cell>
            <Table.Cell>
              <Icon className="universe-time" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-unlocked</Table.Cell>
            <Table.Cell>
              <Icon className="universe-unlocked" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-users</Table.Cell>
            <Table.Cell>
              <Icon className="universe-users" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-upload</Table.Cell>
            <Table.Cell>
              <Icon className="universe-upload" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-view</Table.Cell>
            <Table.Cell>
              <Icon className="universe-view" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-worldwide-web</Table.Cell>
            <Table.Cell>
              <Icon className="universe-worldwide-web" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-magic</Table.Cell>
            <Table.Cell>
              <Icon className="universe-magic" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
          ...
          <Table.Row>
            <Table.Cell>universe-checkout-settings</Table.Cell>
            <Table.Cell>
              <Icon className="universe-checkout-settings" />
            </Table.Cell>
          </Table.Row>
        </Table.Body>
      </Table>
      ...
      <Table>
        ...
        <Table.Body>
          <Table.Row>
            ...
            <Table.Cell>
              <Icon size="tiny" className="universe-1" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-1 size="small"</Table.Cell>
            <Table.Cell>
              <Icon size="small" className="universe-1" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-1 size="large"</Table.Cell>
            <Table.Cell>
              <Icon size="large" className="universe-1" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-1 size="huge"</Table.Cell>
            <Table.Cell>
              <Icon size="huge" className="universe-1" />
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>universe-1 size="massive"</Table.Cell>
            <Table.Cell>
              <Icon size="massive" className="universe-1" />
            </Table.Cell>
          </Table.Row>
        </Table.Body>
      </Table>
      ...
      <Table>
        ...
        <Table.Body>
          <Table.Row>
            ...
            <Table.Cell>
              <Icon size="large" bordered inverted link className="universe-link" />
            </Table.Cell>
          </Table.Row>
        </Table.Body>
      </Table>
