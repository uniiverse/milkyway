...
const stories = storiesOf('Icon', module)
    .add('Default', () =>
        ...
        Table.Cell > < Icon className = "universe-magic" / > < /Table.Cell> <
        /Table.Row> <
        /Table.Body> <
        /Table> <
        /Container>
        ...
        Table.Row >
        <
        Table.Cell > universe - 1 size = "large"
        bordered inverted link < /Table.Cell> <
        Table.Cell > < Icon size = "large"
        bordered inverted link className = "universe-link" / > < /Table.Cell> <
        /Table.Row> <
        /Table.Body> <
        /Table> <
        /Container>
